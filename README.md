...
Each managed profile can choose whether the receiving peer restores its requested display topology after handoff; disabling the option leaves the peer layout untouched.
